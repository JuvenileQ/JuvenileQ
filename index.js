...
const readme = `\
<div>⏳ Year progress <span>${progressBarOfThisYear} ${(progressOfThisYear * 100).toFixed(2)} %</span></div>
...
---
<p align="center">⏰该 <b>README</b> 文件 <b>每三小时</b> 更新一次！（坐标济南）🌱 上次更新于: **${new Date().toLocaleDateString().replace(/\//g, "-") + " " + new Date().toTimeString().substr(0, 8)}**<br />
